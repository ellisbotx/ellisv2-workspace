...
log ""
log "Viewing tip: run $WORKDIR/scripts/serve_dashboard.sh and open http://localhost:8000/trifecta/"
log "(Profitability uses fetch() and must be opened over http://, not file://)"
log "=========================================="
